  ...
  return (
    <div className="about-page">
      ...
      <ul>
        ...
        <li>Local restaurant partners</li>
        <li>Prompt and courteous delivery drivers</li>
        <li>Quick and convenient delivery</li>
      </ul>
      <p>Thank you for choosing our app for your mealtime needs. We look forward to serving you!</p>
    </div>
  );
};
